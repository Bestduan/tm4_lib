...
extern void ADS1256_IO_Init(void);
extern void ADS1256_Write_REG(unsigned char address,unsigned char data);
extern void ADS1256_Init(uint8_t mode);
extern unsigned long ADS1256_ReadData(void);
extern uint8_t ADS1256_Communicate(uint8_t transmitdata);
extern uint32_t ADS1256_Getdata_OneShot(uint8_t Channel);
extern uint32_t ADS1256_Getdata_Continuously(uint8_t Channel);
extern uint8_t ADS1256_Read_REG(unsigned char address);
extern void ADS1256_Getdata_DemoTask(uint8_t Channel,float* advalue);
#endif
