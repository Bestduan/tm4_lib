...
/****************************************************************8******/
#define ADS1115_SCL_SET        GPIOPinWrite(GPIO_PORTD_BASE, GPIO_PIN_6 , GPIO_PIN_6)
#define ADS1115_SCL_CLR        GPIOPinWrite(GPIO_PORTD_BASE, GPIO_PIN_6 , 6)
#define ADS1115_SDA_SET        GPIOPinWrite(GPIO_PORTD_BASE, GPIO_PIN_7 , GPIO_PIN_7)
#define ADS1115_SDA_CLR        GPIOPinWrite(GPIO_PORTD_BASE, GPIO_PIN_7 , 0)
#define	ADS1115_SDA_IN         GPIOPinRead(GPIO_PORTD_BASE, GPIO_PIN_7)

//ADS1115_SDAPort_IN()和ADS1115_SDAPort_OUT()函数定义在.c中，适应不同的单片机，更改IO口方向


#define AD_START   GPIO_ResetBits(GPIOA,GPIO_Pin_1)
#define AD_END     GPIO_SetBits(GPIOA,GPIO_Pin_1)
